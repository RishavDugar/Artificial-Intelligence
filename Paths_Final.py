...
Original file is located at
    https://colab.research.google.com/drive/1ENeTZIKJyTPd8UZ_00bSebLgFhmLQUC-
"""
...
class Cars():
    ...
    def __init__(self, quantity):
        ...
        self.route = [[0 for column in range(2)]
                      for row in range(quantity)]
        self.route_dist = [[0 for column in range(2)]
                      for row in range(quantity)]

#Change the address to correct file locations for lines 38 and 42
    ...
    def printAllPathsUtil(self, u, d, visited, path, id):
        ...
        if u == d:
            ...
            '''if ev.route_dist[id][0] == 0:
              ...
              ev.route_dist[id].append(dist)
              ev.route[id].append(path2)'''
